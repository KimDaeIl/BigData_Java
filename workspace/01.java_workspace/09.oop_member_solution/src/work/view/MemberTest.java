...
public class MemberTest {
	...
	public static void main(String[] args) {
		...
		SpecialMember dto4 = new SpecialMember("suser01", "password01", "유관순", "010-1111-1111", "suser01@work.com", "2017/05/10", 'S', null);
		SpecialMember dto5 = new SpecialMember("suser02", "password02", "김유신", "010-1111-1112", "suser01@work.com", "2017/05/10", 'A', null);
		...
		System.out.println("\n### 회원변경 : user01");
		dto = new GeneralMember("user01", "bluesky", "홍길동", "010-1234-3333", "hong@work.com", "2017/05/10", 'G', 15000);
